...
class Ticket{
    ...
    void setTid(){
        ticketCount++;
        ticketID=value+ticketCount;
        }
    void setStat(bool val){stat=val;}

    int getRnum() const {return rowNum;}
    int getSnum() const {return seatNum;}
    int getTid() const {return ticketID;}
...
class Movie{
    ...
    struct time getTime() const {return movietime;}
